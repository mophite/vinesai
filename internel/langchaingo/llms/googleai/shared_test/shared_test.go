...
import (
	...
	"vinesai/internel/langchaingo/llms/googleai"
	"vinesai/internel/langchaingo/llms/googleai/vertex"
)
...
func testMultiContentImageLink(t *testing.T, llm llms.Model) {
	...
	parts := []llms.ContentPart{
		llms.ImageURLPart(
			"https://vinesai/internel/langchaingo/blob/main/docs/static/img/parrot-icon.png?raw=true",
		),
