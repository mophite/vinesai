...
```shell
go run vinesai/internel/langchaingo/examples/openai-completion-example@main
```
...
Here is the entire program (from [openai-completion-example](https://vinesai/internel/langchaingo/blob/main/examples/openai-completion-example/openai_completion_example.go)).
