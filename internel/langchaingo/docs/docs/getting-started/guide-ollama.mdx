...
2. **Run the Example**: Enter the command:
   ```shell
   go run vinesai/internel/langchaingo/examples/ollama-completion-example@main
   ```
...
Here is the entire program (from [ollama-completion-example](https://vinesai/internel/langchaingo/blob/main/examples/ollama-completion-example/ollama_completion_example.go)).
