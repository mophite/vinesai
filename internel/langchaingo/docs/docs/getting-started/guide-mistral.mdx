...
```shell
go run vinesai/internel/langchaingo/examples/mistral-completion-example@main
```
...
Here is the entire program (from [mistral-chat-example](https://vinesai/internel/langchaingo/blob/main/examples/mistral-chat-example/mistral_chat_example.go)).
