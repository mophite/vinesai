...
func (*CodeReq) Descriptor() ([]byte, []int) {
	return fileDescriptor_368ef0c455d86bef, []int{14}
}
...
func (m *CodeReq) GetPhone() string {
	if m != nil {
		return m.Phone
	}
	return ""
...
func (*CodeRsp) Descriptor() ([]byte, []int) {
	return fileDescriptor_368ef0c455d86bef, []int{15}
}
...
func init() {
	...
	proto.RegisterType((*CodeReq)(nil), "pha.CodeReq")
	proto.RegisterType((*CodeRsp)(nil), "pha.CodeRsp")
}
...
var fileDescriptor_368ef0c455d86bef = []byte{
	...
	,
}
...
type UserClient interface {
	// 获取短信验证码
	Code(c *ava.Context, req *CodeReq, opts ...ava.InvokeOptions) (*CodeRsp, error)
	// 用户登录
...
func (cc *userClient) Code(c *ava.Context, req *CodeReq, opts ...ava.InvokeOptions) (*CodeRsp, error) {
	rsp := &CodeRsp{}
	err := cc.c.InvokeRR(c, "/user/code", req, rsp, opts...)
	return rsp, err
}
...
type UserServer interface {
	// 获取短信验证码
	Code(c *ava.Context, req *CodeReq, rsp *CodeRsp)
	// 用户登录
...
func RegisterUserServer(h UserServer) {
	...
	ava.AvaServer().RegisterHandler("/"+ava.AvaServer().Name()+"/user/code", r.Code)
...
func (r *userHandler) Code(c *ava.Context, req *ava.Packet, interrupt ava.Interceptor) (rsp proto.Message, err error) {
	var in CodeReq
	err = c.Codec().Decode(req.Bytes(), &in)
	if err != nil {
		c.Errorf("server decode packet err=%v |method=%s |data=%s", err, c.Metadata.Method(), req.String())
...
func (m *CodeRsp) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *CodeRsp) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *CodeRsp) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *CodeRsp) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: CodeRsp: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: CodeRsp: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
